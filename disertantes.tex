...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Galante
\subsection{María José Galante: FALTA FOTO y BIO}

\begin{tabular}{ l l}
% \newcolumntype{S}{>{\centering\arraybackslash} m{.4\linewidth} }
{\multirow{3}{*}{\includegraphics[width=0.08\textwidth]{carlos}}} & Instituto de Investigaciones en Ciencia y Tecnología de Materiales, CONICET. \\
